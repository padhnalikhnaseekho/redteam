#!/usr/bin/env python3
"""Groq-Only Benchmark: All attacks x All defenses x Groq models.

Runs groq-qwen (Qwen3 32B) and groq-scout (Llama 4 Scout 17B MoE)
through every attack and defense configuration. All models use Groq's
free-tier LPU inference for fast, zero-cost benchmarking.

Usage:
    python scripts/run_groq_benchmark.py
    python scripts/run_groq_benchmark.py --skip-multi-agent
    python scripts/run_groq_benchmark.py --models groq-qwen
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--models", nargs="+", default=["groq-qwen", "groq-scout"],
        help="Models to test (default: groq-qwen groq-scout)",
    )
    parser.add_argument(
    ...
    console.print()
    console.print("=" * 60)
    console.print("[bold]  Groq Benchmark — All Free-Tier Models[/bold]")
    console.print("=" * 60)
